...
| [@chrock-studio/overload](https://jsr.io/@chrock-studio/overload)             | Type-safe runtime function overloading, validation with Standard Schema                                                               | [Docs](https://jsr.io/@chrock-studio/overload/doc) |
| [Cleverbrush Schema](https://docs.cleverbrush.com/schema)                     | Schema validator, can consume other Standard Schema objects as subschemas                                                             | [Docs](https://github.com/cleverbrush/framework/blob/master/libs/schema/README.md)                    |
